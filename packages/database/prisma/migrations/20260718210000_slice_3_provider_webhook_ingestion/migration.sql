-- Signed provider callbacks are verified by the API first. This narrow
-- function resolves the provider message and applies its state atomically
-- without granting webhook requests a workspace session or bypassing RLS in
-- application code.
