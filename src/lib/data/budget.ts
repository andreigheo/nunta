...
export const expenses: Expense[] = [
  ...
  { id: "ex-3", name: "Meniu standard pentru 160 pers.", categoryId: "bc-2", estimated: 44_800, contracted: 0, actual: 0, paid: 0, status: "quoted" },
  ...
  { id: "ex-14", name: "Camere oaspeți: bloc de 20 camere", categoryId: "bc-8", estimated: 7_600, contracted: 0, actual: 0, paid: 0, status: "estimate" },
...
export const payments: Payment[] = [
  ...
  { id: "p-5", name: "Ajustări rochie: rest de plată", vendor: "Atelier Mira", categoryId: "bc-6", amount: 1_600, dueDate: "2026-12-01", status: "upcoming" },
