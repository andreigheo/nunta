...
export const vendors: Vendor[] = [
  ...
  { id: "v-4", name: "Formatia Acord", category: "DJ & Muzică", city: "Sibiu", verified: false, rating: 4.6, reviews: 54, startingPrice: 7_800, availableOnDate: true, responseTime: "1 zi", styles: ["Live", "Populară", "Lăutărească"], description: "Formație live de 6 persoane, cu repertoriu mixt, de la muzică populară la hituri internaționale." },
