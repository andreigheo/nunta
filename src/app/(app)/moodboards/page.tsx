  ...
  if (!demoMode) {
    return (
      <PlannedFeature
        icon={Images}
        title="Moodboarduri"
        description="Colecțiile vizuale vor fi publicate numai după ce imaginile, drepturile și persistența sunt conectate."
        availableHref="/invitations/editor"
        availableLabel="Continuă în editorul de invitații"
      />
    );
  }
