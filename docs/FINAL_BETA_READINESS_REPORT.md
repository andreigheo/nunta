...
Generated: 2026-07-21T21:46:00.298Z  
Decision source: `pnpm verify:beta`

## Executive verdict

WeddingOS is ready for a controlled beta on the validated source snapshot. The full deterministic gate passed with 253 E2E scenarios, zero failures, zero skipped scenarios and zero retries. Security, data lifecycle, restore, tracing, observability, staging deployment and rollback evidence are all green.
...
| Evidence | Status |
| --- | --- |
| Database and migration identity | VERIFIED; 96 migrations |
| Reference manifest | VERIFIED |
| Unit | 0 failed |
| Integration | 0 failed |
| Full E2E | 253/253; failed 0; skipped 0; retries 0 |
| Dependency, secret and SBOM gate | PASSED; critical 0; high 0; secrets 0 |
| Trace and privacy proof | VERIFIED; privacy PASSED; 29 spans in distributed proof |
...
| Rollback | HEALTHY; beta-1784669617558-b → beta-1784669617558-a |
