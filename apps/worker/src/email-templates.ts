...
function renderPlusWelcome(
  ...
  const heroUrl = assetUrl("welcome-plus-hero.png");
  const introUrl = assetUrl("welcome-plus-intro.png");
  const ctaUrl = assetUrl("welcome-plus-cta-strip.png");
  const featuresUrl = assetUrl("welcome-plus-features.png");
  const storyUrl = assetUrl("welcome-plus-story.png");
  const footerUrl = assetUrl("welcome-plus-footer.png");
...
<html lang="ro">
  <head>
    ...
    <style>
      ...
      @media only screen and (max-width: 804px) {
        ...
        .outer-pad { padding: 12px 0 24px !important; }
      }
    </style>
  </head>
  <body style="margin:0;padding:0;background:#f9f8fb;color:#19151d;">
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;background:#f9f8fb;">
      <tr>
        <td class="outer-pad" align="center" style="padding:20px 20px 38px;">
          <table role="presentation" class="email-shell" width="764" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:764px;background:#fffaff;">
            <tr>
              <td>
                <img src="${escapeHtml(heroUrl)}" width="764" alt="Sarbato — planifici mai multe momente frumoase" style="width:100%;max-width:764px;height:auto;">
              </td>
            </tr>
            <tr>
              <td>
                <img src="${escapeHtml(introUrl)}" width="764" alt="Bun venit în Sarbato. Evenimentul tău începe aici. Plan Plus — tot ce ai nevoie pentru evenimente reușite, într-un singur loc." style="width:100%;max-width:764px;height:auto;">
              </td>
            </tr>
            <tr>
              <td>
                <a href="${safeDashboardUrl}" target="_blank" aria-label="Începe organizarea în Sarbato" style="display:block;text-decoration:none;">
                  <img src="${escapeHtml(ctaUrl)}" width="764" alt="Începe organizarea" style="width:100%;max-width:764px;height:auto;">
                </a>
              </td>
            </tr>
            <tr>
              <td>
                <img src="${escapeHtml(featuresUrl)}" width="764" alt="Plan, oameni, furnizori și ziua evenimentului — toate într-un singur loc" style="width:100%;max-width:764px;height:auto;">
              </td>
            </tr>
            <tr>
              <td>
                <img src="${escapeHtml(storyUrl)}" width="764" alt="Momente mai frumoase împreună. Orice eveniment are o poveste frumoasă. Noi te ajutăm să o scrii." style="width:100%;max-width:764px;height:auto;">
              </td>
            </tr>
            <tr>
              <td>
                <img src="${escapeHtml(footerUrl)}" width="764" alt="Sarbato — Plan, Oameni, Furnizori, Ziua evenimentului. Mai multe momente care contează." style="width:100%;max-width:764px;height:auto;">
              </td>
            </tr>
          </table>
        </td>
