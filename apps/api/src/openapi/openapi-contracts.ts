...
const schemas: Record<string, ZodTypeAny> = {
  ...
  UpdateCopilotSettings: updateCopilotSettingsSchema,
  CreateCopilotMemory: createCopilotMemorySchema,
  UpdateCopilotMemory: updateCopilotMemorySchema,
  SearchCopilotMemory: searchCopilotMemorySchema,
  ...
  MagicLinkSessionCreated: magicLinkSessionCreatedSchema,
  ...
  GuestInvitationBootstrap: guestInvitationBootstrapSchema,
  GuestRsvpBootstrap: guestRsvpBootstrapSchema,
...
const requestByRoute: Array<[RegExp, string]> = [
  ...
  [
    /PATCH \/api\/v1\/workspaces\/\{workspaceId\}\/copilot\/settings$/,
    "UpdateCopilotSettings",
  ],
  [
    /POST \/api\/v1\/workspaces\/\{workspaceId\}\/copilot\/memories$/,
    "CreateCopilotMemory",
  ],
  [
    /PATCH \/api\/v1\/workspaces\/\{workspaceId\}\/copilot\/memories\/\{memoryId\}$/,
    "UpdateCopilotMemory",
  ],
  [
    /POST \/api\/v1\/workspaces\/\{workspaceId\}\/copilot\/memories\/search$/,
    "SearchCopilotMemory",
  ],
  [
...
const responseByRoute: Array<[RegExp, string]> = [
  ...
  [/POST \/api\/v1\/auth\/magic-link-exchanges$/, "MagicLinkSessionCreated"],
  ...
  [/GET \/api\/v1\/guest\/invitation$/, "GuestInvitationBootstrap"],
  [/GET \/api\/v1\/guest\/rsvp\/bootstrap$/, "GuestRsvpBootstrap"],
